...
###**INTRODUCTION**
- The "Market Basket Analysis" analyses **point of sale transactions**. 
- It uses the information on what customers buy to provide insights into who they are and why they make certain purchases.
- It gives a rough idea about which products are purchased together and which are most amenable to promotion (application to catalog design - for example: Plate, spoon, fork and related dining items have a high probability of being purchased together)
- Further, it allows us to predict the subsequent purchases.
...
# class(final_recomm$confidence)
# head(final_recomm)
# Max Confidence : If X is bought then Y will be purchased 
final_recomm[final_recomm$confidence == 1, ]
```